...
//
//     cappedMinter =
//       _createCappedMinter(address(token), cappedMinterAdmin, DEFAULT_CAP, DEFAULT_START_TIME,
...
//   }
//
//   function _boundToValidTimeControls(uint48 _startTime, uint48 _expirationTime) internal view returns (uint48,
// uint48) {
...
//     _grantMinterRole(cappedMinter, cappedMinterAdmin, _minter);
//
//     vm.expectRevert(abi.encodeWithSelector(ZkCappedMinterV2.ZkCappedMinterV2__CapExceeded.selector, _minter,
// _amount));
//     vm.prank(_minter);
//     cappedMinter.mint(_receiver, _amount);
//   }
...
//   function testFuzz_InitialMetadataURIIsEmpty(address _admin, uint256 _cap, uint48 _startTime, uint48
// _expirationTime)
//     public
//   {
//     (_startTime, _expirationTime) = _boundToValidTimeControls(_startTime, _expirationTime);
